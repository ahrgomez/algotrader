...
#
DEFAULT_PATH = "algotrader.test.conf"
...
class Config(object):
    ...
    def __str__(self):
        ...
        s += "active_account: {}".format(self.instruments_list)
        return s
    ...
    def load(self, path):
        ...
        try:
            with open(os.path.expanduser(path)) as f:
                ...
                self.instruments_list = y.get( "instruments_list", self.instruments_list)
    ...
    def validate(self):
        ...
        if self.instruments_list is None:
            raise ConfigValueError("instruments list")
